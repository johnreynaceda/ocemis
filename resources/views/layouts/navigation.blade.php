        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/" class="flex space-x-2 text-main items-center">
                        <h1 class="text-xl font-semibold">O-CEMIS </h1>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (auth()->user()->role_id == 2)
                        <x-nav-link :href="route('coordinator.appointments')" :active="request()->routeIs('coordinator.appointments')">
                            {{ __('Appointments') }}
                        </x-nav-link>
                    @endif
                    @if (auth()->user()->role_id == 3)
                        <x-nav-link :href="route('client.appointment')" :active="request()->routeIs('client.appointment')">
                            {{ __('My Appointment') }}
                        </x-nav-link>
                    @endif
                </div>
