        ...
        <div class="grid grid-cols-4 gap-5">
            <div class="border bg-white shadow rounded-xl flex space-x-3 items-center p-5">
                ...
                <div>
                    ...
                    <h1 class="text-3xl">
                        {{ \App\Models\Appointment::whereHas('weddingInfo', function ($query) {
            ...
            <div class="border bg-white shadow rounded-xl flex space-x-3 items-center p-5">
                ...
                <div>
                    ...
                    <h1 class="text-3xl">
                        {{ \App\Models\Appointment::whereHas('baptismalInfo', function ($query) {
                            $query->whereJsonContains('coordinator', (string) auth()->user()->coordinator->id);
                        })->count() }}
                    </h1>
                </div>
            ...
            <div class="border bg-white shadow rounded-xl flex space-x-3 items-center p-5">
                ...
                <div>
                    ...
                    <h1 class="text-3xl">
                        {{ \App\Models\Appointment::whereHas('fellowShipInfo', function ($query) {
